...
let g:colors_name="_jwe_purple"


let Italic = ""
if exists('g:_jwe_italic')
  let Italic = "italic"
endif
let g:_jwe_italic = get(g:, '_jwe_italic', 0)

let Bold = ""
if exists('g:_jwe_bold')
  let Bold = "bold"
endif

let g:_jwe_bold = get(g:, '_jwe_bold', 0)
...
hi CursorLine guifg=NONE ctermfg=NONE guibg=#28284E ctermbg=234 gui=NONE cterm=NONE
